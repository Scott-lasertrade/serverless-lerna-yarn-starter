...
exports.manufacturerIsApproved1638766892094 = void 0;
class manufacturerIsApproved1638766892094 {
    constructor() {
        this.name = 'manufacturerIsApproved1638766892094';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "manufacturer" ADD "is_approved" boolean NOT NULL DEFAULT true`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "manufacturer" DROP COLUMN "is_approved"`);
        });
    }
}
