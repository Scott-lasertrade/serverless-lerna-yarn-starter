...
exports.ReplaceExistingCategories1641773705776 = void 0;
class ReplaceExistingCategories1641773705776 {
    constructor() {
        this.name = 'ReplaceExistingCategories1641773705776';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "category_to_product" ("category" integer NOT NULL, "product" integer NOT NULL, CONSTRAINT "PK_bdb9eee556e86845822077a43e6" PRIMARY KEY ("category", "product"))`);
            yield queryRunner.query(`CREATE INDEX "IDX_e158661b3e511f835111760388" ON "category_to_product" ("category") `);
            yield queryRunner.query(`CREATE INDEX "IDX_39298d9ea92b786b515da6e2cf" ON "category_to_product" ("product") `);
            ...
            yield queryRunner.query(`ALTER TABLE "category" ADD "key" character varying NOT NULL`);
            yield queryRunner.query(`ALTER TABLE "category" ADD CONSTRAINT "UQ_7c82c39b0dc8ef1ba334eb615a3" UNIQUE ("key")`);
            yield queryRunner.query(`ALTER TABLE "category" ADD "parent_id" integer`);
            yield queryRunner.query(`ALTER TABLE "category" ADD CONSTRAINT "FK_1117b4fcb3cd4abb4383e1c2743" FOREIGN KEY ("parent_id") REFERENCES "category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "category_to_product" ADD CONSTRAINT "FK_e158661b3e511f835111760388a" FOREIGN KEY ("category") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
            yield queryRunner.query(`ALTER TABLE "category_to_product" ADD CONSTRAINT "FK_39298d9ea92b786b515da6e2cfc" FOREIGN KEY ("product") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "category_to_product" DROP CONSTRAINT "FK_39298d9ea92b786b515da6e2cfc"`);
            yield queryRunner.query(`ALTER TABLE "category_to_product" DROP CONSTRAINT "FK_e158661b3e511f835111760388a"`);
            yield queryRunner.query(`ALTER TABLE "category" DROP CONSTRAINT "FK_1117b4fcb3cd4abb4383e1c2743"`);
            yield queryRunner.query(`ALTER TABLE "category" DROP COLUMN "parent_id"`);
            yield queryRunner.query(`ALTER TABLE "category" DROP CONSTRAINT "UQ_7c82c39b0dc8ef1ba334eb615a3"`);
            yield queryRunner.query(`ALTER TABLE "category" DROP COLUMN "key"`);
            yield queryRunner.query(`DROP INDEX "public"."IDX_39298d9ea92b786b515da6e2cf"`);
            yield queryRunner.query(`DROP INDEX "public"."IDX_e158661b3e511f835111760388"`);
            yield queryRunner.query(`DROP TABLE "category_to_product"`);
            ...
            (2, 2);
            `);
            yield queryRunner.query(`CREATE MATERIALIZED VIEW "category_look_up" AS select c.id as category_id, 0 as category_type_id, 0 as category_function_id, c.name as guid, 1 as depth from category c 
        union
