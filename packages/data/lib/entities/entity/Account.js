...
__decorate([
    (0, typeorm_1.ManyToMany)(() => User_1.User, (user) => user.accounts),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => Address_1.Address, (address) => address.account),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", Address_1.Address)
], Account.prototype, "address", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Listing_1.Listing, (listing) => listing.account, {
        cascade: true,
    }),
    __metadata("design:type", Array)
], Account.prototype, "listings", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Offer_1.Offer, (offer) => offer.account, {
        cascade: true,
    }),
    __metadata("design:type", Array)
], Account.prototype, "offers", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Watchlist_1.Watchlist, (watchlist) => watchlist.account, {
        cascade: true,
    }),
    __metadata("design:type", Array)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => Question_1.Question, (question) => question.asker, {
        cascade: true,
    }),
    __metadata("design:type", Array)
], Account.prototype, "questions", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => CartItem_1.CartItem, (cartItem) => cartItem.account, {
        cascade: true,
    }),
    __metadata("design:type", Array)
