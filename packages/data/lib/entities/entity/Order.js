...
__decorate([
    typeorm_1.ManyToOne(() => Listing_1.Listing, (listing) => listing.orders),
    __metadata("design:type", Listing_1.Listing)
], Order.prototype, "listing", void 0);
__decorate([
    typeorm_1.ManyToOne(() => OrderStatus_1.OrderStatus, (orderStatus) => orderStatus.orders),
    __metadata("design:type", OrderStatus_1.OrderStatus)
], Order.prototype, "status", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Account_1.Account, (account) => account.orders_bought),
    __metadata("design:type", Account_1.Account)
], Order.prototype, "buyer", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Checkout_1.Checkout, (checkout) => checkout.orders, {
        onDelete: 'CASCADE',
    }),
...
__decorate([
    typeorm_1.Column('decimal', { precision: 12, scale: 2, default: 0 }),
    __metadata("design:type", Number)
], Order.prototype, "fixed_fee", void 0);
__decorate([
    typeorm_1.Column('decimal', { precision: 3, scale: 0, default: 11 }),
    __metadata("design:type", Number)
], Order.prototype, "variable_fee", void 0);
__decorate([
    typeorm_1.OneToMany(() => OrderLineItem_1.LineItem, (lineItem) => lineItem.order),
    __metadata("design:type", Array)
], Order.prototype, "line_items", void 0);
__decorate([
    typeorm_1.OneToMany(() => Transaction_1.Transaction, (transaction) => transaction.order),
    __metadata("design:type", Array)
], Order.prototype, "transactions", void 0);
__decorate([
    typeorm_1.OneToMany(() => OrderHistory_1.OrderHistory, (order_history) => order_history.order),
    __metadata("design:type", Array)
], Order.prototype, "history", void 0);
Order = __decorate([
    typeorm_1.Entity('order'),
    typeorm_1.Unique(['order_number'])
], Order);
exports.Order = Order;
