...
import { ManufacturerSearchView } from '../views/materialized/ManufacturerSearchView';
import { ManufacturerFuzzySearchView } from '../views/materialized/ManufacturerFuzzySearchView';
