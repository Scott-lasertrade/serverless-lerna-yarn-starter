...
export class LiveListingsView1641447596508 implements MigrationInterface {
    name = 'LiveListingsView1641447596508';
    ...
    `);
        ...
        await queryRunner.query(`CREATE MATERIALIZED VIEW "category_look_up" AS 
