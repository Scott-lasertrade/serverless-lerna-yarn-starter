...
export class InitialSetup1635981526022 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "category" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "country" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(64) NOT NULL, "abbreviation" character varying(3) NOT NULL, CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "address_type" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(16) NOT NULL, CONSTRAINT "PK_7e192deb7cdcfa2b478be7d664f" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "address" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "state" character varying(50) NOT NULL, "post_code" character varying(16) NOT NULL, "address_line_1" character varying(128) NOT NULL, "address_line_2" character varying(128) NOT NULL, "suburb" character varying(50) NOT NULL, "countryId" integer, "addressTypeId" integer, "accountId" integer, CONSTRAINT "REL_b46b132f3f3f727522cf8eb40c" UNIQUE ("accountId"), CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "offer_status" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "name" character varying(100) NOT NULL, CONSTRAINT "PK_1af4df08e97fbc4569db6ca1ea4" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "user" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "cognito_user_id" character varying NOT NULL, CONSTRAINT "UQ_ad92d96ba85bbf1b7f84acc238a" UNIQUE ("cognito_user_id"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "account" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "business_name" character varying(128), "is_status_approved" boolean, "structure" character varying, "registration_number" character varying, "category" character varying(32), "addressId" integer, CONSTRAINT "REL_d96017d82b031439613c39c1ec" UNIQUE ("addressId"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "currency_type" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(32) NOT NULL, "abbreviation" character varying(3) NOT NULL, "symbol" character varying(1) NOT NULL, CONSTRAINT "PK_a890ec72560063dacbfbbbdf4dc" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "usage_type" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_34c20f258f4248aae247099afac" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "usage" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "metric" character varying NOT NULL, "value" integer, "usageTypeId" integer, CONSTRAINT "PK_7bc33e71ab6c3b71eac72950b44" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE TABLE "listing_accessory" ("id" SERIAL NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "deleted_date" TIMESTAMP, "accessoryId" integer, "usageId" integer, "listingId" integer, CONSTRAINT "REL_b349145bd9c485b70c858d7823" UNIQUE ("usageId"), CONSTRAINT "PK_c794de89b573c9237bdf703cd09" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "account_to_user" ("user" integer NOT NULL, "account" integer NOT NULL, CONSTRAINT "PK_3978fa2497587e59dc5a6d8dee2" PRIMARY KEY ("user", "account"))`
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_6d52cc47cafff3530bf0acfe7c" ON "account_to_user" ("user") `
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_90a4ae864cad7ed8f71d12cb03" ON "account_to_user" ("account") `
        );
        await queryRunner.query(
            `CREATE TABLE "product_to_manufacturer" ("manufacturer" integer NOT NULL, "product" integer NOT NULL, CONSTRAINT "PK_308e557fa126e96448bf04c0130" PRIMARY KEY ("manufacturer", "product"))`
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_3a3f971c3bc634059cf4bb1b13" ON "product_to_manufacturer" ("manufacturer") `
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_0d24fc4c9a8a1e6a2a8257ff40" ON "product_to_manufacturer" ("product") `
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "offer" ADD CONSTRAINT "FK_d09c379643b767efa904c4c62ca" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "offer" ADD CONSTRAINT "FK_5c51734e67bda8400c0b2bbf7b0" FOREIGN KEY ("statusId") REFERENCES "offer_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "account" ADD CONSTRAINT "FK_d96017d82b031439613c39c1ecb" FOREIGN KEY ("addressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "usage" ADD CONSTRAINT "FK_d43913e23172065f5f72714dca3" FOREIGN KEY ("usageTypeId") REFERENCES "usage_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "listing_accessory" ADD CONSTRAINT "FK_b349145bd9c485b70c858d7823f" FOREIGN KEY ("usageId") REFERENCES "usage"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "listing_accessory" ADD CONSTRAINT "FK_a368089281d1cde464194e232bd" FOREIGN KEY ("listingId") REFERENCES "listing"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "listing" ADD CONSTRAINT "FK_a03aef8a719efff453754daf2f9" FOREIGN KEY ("usageId") REFERENCES "usage"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" ADD CONSTRAINT "FK_dbb1336190baa1467ceeee8f7a8" FOREIGN KEY ("currencyTypeId") REFERENCES "currency_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" ADD CONSTRAINT "FK_7770a3a5601a9f2bbb71908d14f" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "listing" ADD CONSTRAINT "FK_44f04ea4eba6eec53da8f394a40" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "product" ADD CONSTRAINT "FK_139c435f999a26585f495d9ca71" FOREIGN KEY ("usageTypeId") REFERENCES "usage_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "account_to_user" ADD CONSTRAINT "FK_6d52cc47cafff3530bf0acfe7c0" FOREIGN KEY ("user") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`
        );
        await queryRunner.query(
            `ALTER TABLE "account_to_user" ADD CONSTRAINT "FK_90a4ae864cad7ed8f71d12cb03f" FOREIGN KEY ("account") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "product_to_manufacturer" ADD CONSTRAINT "FK_3a3f971c3bc634059cf4bb1b133" FOREIGN KEY ("manufacturer") REFERENCES "manufacturer"("id") ON DELETE CASCADE ON UPDATE CASCADE`
        );
        await queryRunner.query(
            `ALTER TABLE "product_to_manufacturer" ADD CONSTRAINT "FK_0d24fc4c9a8a1e6a2a8257ff405" FOREIGN KEY ("product") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
    ...
    `);
        ...
        await queryRunner.query(`CREATE MATERIALIZED VIEW "product_fuzzy_search_view" AS 
    ...
    `);
        ...
        await queryRunner.query(`CREATE MATERIALIZED VIEW "manufacturer_fuzzy_search_view" AS 
        select word from ts_stat('
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "schema" = $2 AND "name" = $3`,
            ['MATERIALIZED_VIEW', 'public', 'manufacturer_fuzzy_search_view']
        );
        await queryRunner.query(
            `DROP MATERIALIZED VIEW "manufacturer_fuzzy_search_view"`
        );
        await queryRunner.query(
            `DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "schema" = $2 AND "name" = $3`,
            ['MATERIALIZED_VIEW', 'public', 'product_fuzzy_search_view']
        );
        await queryRunner.query(
            `DROP MATERIALIZED VIEW "product_fuzzy_search_view"`
        );
        await queryRunner.query(
            `DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "schema" = $2 AND "name" = $3`,
        ...
        await queryRunner.query(
            `ALTER TABLE "product_to_manufacturer" DROP CONSTRAINT "FK_0d24fc4c9a8a1e6a2a8257ff405"`
        );
        await queryRunner.query(
            `ALTER TABLE "product_to_manufacturer" DROP CONSTRAINT "FK_3a3f971c3bc634059cf4bb1b133"`
        );
        await queryRunner.query(
            `ALTER TABLE "account_to_user" DROP CONSTRAINT "FK_90a4ae864cad7ed8f71d12cb03f"`
        );
        await queryRunner.query(
            `ALTER TABLE "account_to_user" DROP CONSTRAINT "FK_6d52cc47cafff3530bf0acfe7c0"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "product" DROP CONSTRAINT "FK_139c435f999a26585f495d9ca71"`
        );
        await queryRunner.query(
            `ALTER TABLE "product_image" DROP CONSTRAINT "FK_40ca0cd115ef1ff35351bed8da2"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" DROP CONSTRAINT "FK_44f04ea4eba6eec53da8f394a40"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" DROP CONSTRAINT "FK_483cba76a7945db3ed1f4f392dc"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" DROP CONSTRAINT "FK_7770a3a5601a9f2bbb71908d14f"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" DROP CONSTRAINT "FK_dbb1336190baa1467ceeee8f7a8"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing" DROP CONSTRAINT "FK_a03aef8a719efff453754daf2f9"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing_image" DROP CONSTRAINT "FK_b0d09774d741ddf347b214b95e0"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing_accessory" DROP CONSTRAINT "FK_a368089281d1cde464194e232bd"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing_accessory" DROP CONSTRAINT "FK_b349145bd9c485b70c858d7823f"`
        );
        await queryRunner.query(
            `ALTER TABLE "listing_accessory" DROP CONSTRAINT "FK_0e5241ed8b4c972ffd14008fbc0"`
        );
        await queryRunner.query(
            `ALTER TABLE "usage" DROP CONSTRAINT "FK_d43913e23172065f5f72714dca3"`
        );
        await queryRunner.query(
            `ALTER TABLE "account" DROP CONSTRAINT "FK_d96017d82b031439613c39c1ecb"`
        );
        await queryRunner.query(
            `ALTER TABLE "offer" DROP CONSTRAINT "FK_5c51734e67bda8400c0b2bbf7b0"`
        );
        await queryRunner.query(
            `ALTER TABLE "offer" DROP CONSTRAINT "FK_d09c379643b767efa904c4c62ca"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP INDEX "public"."IDX_0d24fc4c9a8a1e6a2a8257ff40"`
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_3a3f971c3bc634059cf4bb1b13"`
        );
        await queryRunner.query(`DROP TABLE "product_to_manufacturer"`);
        await queryRunner.query(
            `DROP INDEX "public"."IDX_90a4ae864cad7ed8f71d12cb03"`
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_6d52cc47cafff3530bf0acfe7c"`
        );
        await queryRunner.query(`DROP TABLE "account_to_user"`);
        await queryRunner.query(
            `DROP INDEX "public"."IDX_045819719c1b83e8d6f7605556"`
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_4b98c619daba868cdb97ae1e5b"`
        );
        ...
        await queryRunner.query(`DROP TABLE "listing_accessory"`);
        await queryRunner.query(`DROP TABLE "usage"`);
        await queryRunner.query(`DROP TABLE "usage_type"`);
